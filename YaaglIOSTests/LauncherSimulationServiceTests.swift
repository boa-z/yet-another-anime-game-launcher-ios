...
final class LauncherSimulationServiceTests: XCTestCase {
    ...
    func testLaunchProgramEmitsPatchRunRevertTraceAndConfigurationLogs() async throws {
        ...
        XCTAssertTrue(logs.contains("launch: Box64-style translation reference models x86_64 -> ARM64 via userspace emulation, DynaRec, and native library bridge concepts; no emulator binary, JIT, or translated process is bundled or executed on iOS"))
